 ...
 *
 * The declaratrions here have to be in a header file, because they need
 * to be know both tp the kernel module (in chardev2.c) and the process
 ...
 *
 * The first arguement, MAJOR_NUM, is the major device number we are using.
 *
