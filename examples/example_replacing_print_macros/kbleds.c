 ...
 * virtual terminal iioctl operations, please see file:
 *      drivers/tty/vt/vt_ioctl.c, function vt_ioctl().
 *
 * The argument to KDSETLED is alternatively set to 7 (thus causing the led
 * mode to be set to LED_SHOW_IOCTL, and all the leds are lit) and to OxFF
 * (any value above 7 swithes back the led mdoe to LED_SHOW_FLAGS, thus
